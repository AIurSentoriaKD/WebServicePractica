...
Namespace ServiceReference1
    ...
    Public Interface WebService1Soap
        ...
        Function Potencia(ByVal request As ServiceReference1.PotenciaRequest) As ServiceReference1.PotenciaResponse
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/Potencia", ReplyAction:="*")>  _
        Function PotenciaAsync(ByVal request As ServiceReference1.PotenciaRequest) As System.Threading.Tasks.Task(Of ServiceReference1.PotenciaResponse)
    ...
    Partial Public Class PotenciaRequest
        ...
        Public Body As ServiceReference1.PotenciaRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As ServiceReference1.PotenciaRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class PotenciaResponse
        ...
        Public Body As ServiceReference1.PotenciaResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As ServiceReference1.PotenciaResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class WebService1SoapClient
        ...
        Public Function Raiz(ByVal n1 As Double) As Double Implements ServiceReference1.WebService1Soap.Raiz
            Return MyBase.Channel.Raiz(n1)
        End Function
        
        Public Function RaizAsync(ByVal n1 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference1.WebService1Soap.RaizAsync
            Return MyBase.Channel.RaizAsync(n1)
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function ServiceReference1_WebService1Soap_Potencia(ByVal request As ServiceReference1.PotenciaRequest) As ServiceReference1.PotenciaResponse Implements ServiceReference1.WebService1Soap.Potencia
            Return MyBase.Channel.Potencia(request)
        End Function
        
        Public Function Potencia(ByVal n1 As Double, ByVal n2 As String) As Double
            Dim inValue As ServiceReference1.PotenciaRequest = New ServiceReference1.PotenciaRequest()
            inValue.Body = New ServiceReference1.PotenciaRequestBody()
            inValue.Body.n1 = n1
            inValue.Body.n2 = n2
            Dim retVal As ServiceReference1.PotenciaResponse = CType(Me,ServiceReference1.WebService1Soap).Potencia(inValue)
            Return retVal.Body.PotenciaResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function ServiceReference1_WebService1Soap_PotenciaAsync(ByVal request As ServiceReference1.PotenciaRequest) As System.Threading.Tasks.Task(Of ServiceReference1.PotenciaResponse) Implements ServiceReference1.WebService1Soap.PotenciaAsync
            Return MyBase.Channel.PotenciaAsync(request)
        End Function
        
        Public Function PotenciaAsync(ByVal n1 As Double, ByVal n2 As String) As System.Threading.Tasks.Task(Of ServiceReference1.PotenciaResponse)
            Dim inValue As ServiceReference1.PotenciaRequest = New ServiceReference1.PotenciaRequest()
            inValue.Body = New ServiceReference1.PotenciaRequestBody()
            inValue.Body.n1 = n1
            inValue.Body.n2 = n2
            Return CType(Me,ServiceReference1.WebService1Soap).PotenciaAsync(inValue)
        End Function
        
        Public Function Seno(ByVal n1 As Double) As Double Implements ServiceReference1.WebService1Soap.Seno
            Return MyBase.Channel.Seno(n1)
        End Function
        
        Public Function SenoAsync(ByVal n1 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference1.WebService1Soap.SenoAsync
            Return MyBase.Channel.SenoAsync(n1)
        End Function
        
        Public Function Coseno(ByVal n1 As Double) As Double Implements ServiceReference1.WebService1Soap.Coseno
            Return MyBase.Channel.Coseno(n1)
        End Function
        
        Public Function CosenoAsync(ByVal n1 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference1.WebService1Soap.CosenoAsync
            Return MyBase.Channel.CosenoAsync(n1)
        End Function
        
        Public Function Tangente(ByVal n1 As Double) As Double Implements ServiceReference1.WebService1Soap.Tangente
            Return MyBase.Channel.Tangente(n1)
        End Function
        
        Public Function TangenteAsync(ByVal n1 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference1.WebService1Soap.TangenteAsync
